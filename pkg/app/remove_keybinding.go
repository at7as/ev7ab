...
// func setKeybinding(_ *gocui.Gui) error {
...
// 	app.position++
// 	if app.position < len(app.result.show)-1 {
// 		app.position++
// 	}
...
// 		app.result.a.selected = !app.result.a.selected
// 	}
...
// 	for i := range app.result.list {
// 		app.result.list[i].selected = selected
// 	}
...
// 		for i, v := range app.result.list {
// 			if v.status == psActive && v.selected {
// 				app.result.list[i].status = psHolded
// 			}
// 		}
// 	} else {
...
// 	if app.result.selected() {
// 		for i, v := range app.result.list {
// 			if v.status == psHolded && v.selected {
// 				app.result.list[i].status = psActive
// 			}
// 		}
// 	} else {
...
// 		for i, v := range app.result.list {
// 			if v.selected {
// 				app.result.list[i].selected = false
// 				app.result.list[i].status = psTerminated
// 			}
// 		}
// 	} else {
// 		app.result.a.selected = false
...
// 	app.v.edit.selectStageLeft()
// 	app.v.edit.shiftCursorY()
...
// 	app.v.edit.selectNodeDown()

// 	return nil
// }

// func onEditInsertStage(g *gocui.Gui, _ *gocui.View) error {
...
// func onEditDeleteStage(g *gocui.Gui, _ *gocui.View) error {
...
// 		return app.openModal(newNodeSizeBox()) //  openNodeSize(g, v)
// 	}
...
// func openNodeSize(g *gocui.Gui, _ *gocui.View) error {
